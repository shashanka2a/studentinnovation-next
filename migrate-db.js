...
/**
 * Database Migration Script with Connection Pooler
 * This script will try different connection methods
 */
...
const DATABASE_URLS = [
  "postgresql://postgres:e7p4UxfCArSnTe57@db.hvadstswmmshkxxdpelu.supabase.co:5432/postgres",
  "postgresql://postgres:e7p4UxfCArSnTe57@db.hvadstswmmshkxxdpelu.supabase.co:6543/postgres",
  "postgresql://postgres.e7p4UxfCArSnTe57@aws-0-us-east-1.pooler.supabase.com:6543/postgres"
]

console.log('🚀 Starting database migration with multiple connection attempts...')
